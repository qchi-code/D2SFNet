...
def cfg():
    ...
    exclude_label = None  # None, for not excluding test labels; Setting 1: None, Setting 2: True
    exclude_label_source = [1, 2, 3, 6]
    ...
    test_label = [1, 6]  # for evaluation   test_label = [1, 2, 3, 4]
    ...
    save_snapshot_every = 10000  # 1000
    max_iters_per_load = 1000  # epoch size, interval for reloading the dataset

    # Network
    reload_model_path = './exps/D2SFNet_train_CHAOST2_cv0/1/snapshots/30000.pth'
    ...
    # sources_data_path = 'E:/medical_code/Data_preprocessing/MMS'
    sources_data_path = 'E:/medical_code/Data_preprocessing/SABS'
